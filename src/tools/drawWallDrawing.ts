...
export function drawOnWallAppStateDrawing(drawings:IDrawing[],corners:ICorners,ctx:CanvasRenderingContext2D){
...
export function drawOnWallSituationStateControllers(controllers:IController[],corners:ICorners,ctx:CanvasRenderingContext2D){
